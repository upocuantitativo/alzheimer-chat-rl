...
TOPIC_BANK = {
    "es": {
        "musica": ["copla", "Joan Manuel Serrat", "Antonio Machín", "tunas universitarias",
                   "boleros", "Rocío Jurado", "Camilo Sesto", "Lola Flores", "Concha Piquer",
                   "Marifé de Triana", "Antonio Molina", "Juanito Valderrama"],
        "comida": ["paella", "tortilla de patatas", "gazpacho", "cocido madrileño",
                   "churros con chocolate", "fabada asturiana", "lechazo asado",
                   "jamón serrano", "migas extremeñas", "salmorejo"],
        "lugares": ["el pueblo de mi infancia", "la playa de Cádiz", "Sevilla",
                    "Madrid en los años 60", "Galicia", "la huerta", "el mercado del pueblo",
                    "la plaza mayor", "la iglesia del barrio"],
        "familia": ["mi madre", "mi marido", "mis hijos", "mis nietos", "mi hermana mayor",
                    "mi padre", "mis hermanos", "la familia reunida en Navidad"],
        "oficios": ["maestra", "ama de casa", "agricultor", "panadero", "modista",
                    "administrativo", "carpintero", "sastre", "tendero"],
        "aficiones": ["coser", "el huerto", "leer prensa", "el ganchillo", "cantar",
                      "el fútbol", "los toros", "la pesca", "el dominó", "las cartas",
                      "pasear por el campo", "hacer punto"],
        "futbol": ["el Real Madrid", "el Barça", "el Atlético de Madrid", "la selección española",
                   "Di Stéfano", "Butragueño", "Raúl", "el Mundial del 82",
                   "el fútbol de los años 60", "el Bernabéu"],
        "historia": ["la posguerra", "la Transición", "el franquismo", "la República",
                     "la guerra civil", "los años del hambre", "el NODO",
                     "el primer televisor", "la SEAT 600"],
        "natura": ["el campo", "los animales de granja", "las flores del jardín",
                   "la huerta familiar", "las estaciones del año", "la siega",
                   "la vendimia", "la matanza del cerdo"],
        "religion": ["la Semana Santa", "la primera comunión", "el rosario",
                     "la iglesia del pueblo", "las procesiones", "la Virgen del pueblo"],
        "copla": ["La bien pagá", "Pena penita pena", "Ojos verdes", "El emigrante",
                  "Suspiros de España", "Tatuaje", "La Lola se va a los puertos"],
        "ciclismo": ["Bahamontes", "Induráin", "el Tour de Francia",
                     "el Giro de Italia", "la Vuelta a España", "Ángel Nieto"],
    },
    "en": {
        ...
        "hobbies": ["knitting", "the garden", "reading the paper", "crochet", "singing",
                    "baseball", "fishing", "card games"],
        "sports": ["baseball", "football", "boxing", "golf", "the World Series"],
        "history": ["World War II", "the 1950s boom", "the moon landing", "JFK"],
    },
}
